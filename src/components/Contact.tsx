          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-4 py-3 bg-cream/10 rounded-lg hover:bg-cream/20 transition-colors group"
              >
                <Instagram className="w-6 h-6 text-warm-gold group-hover:scale-110 transition-transform" />
          ...
          <div className="border-t border-cream/20 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="font-body text-sm text-cream/60">
                © {new Date().getFullYear()} Bonjour Cafe. {t('footer.rights')}.
              </p>
              <p className="font-body text-sm text-cream/60 flex items-center gap-1">
                {t('footer.made')} <Heart className="w-4 h-4 text-warm-gold fill-warm-gold" /> {t('footer.in')}
              </p>
            </div>
          </div>
        </div>
